    ...
    return (
        <div className="bg-cblue-800 w-full h-screen" name="home">
            ...
            <div className="mx-auto max-w-[980px] lg:max-w-[820px] xl:max-w-[1024px] px-8  sm:pt-16 flex flex-col justify-center h-full text-cpink-50">
                ...
                <h2 className="text-2xl sm:text-4xl font-light text-cpink-50 my-4">
                ...
                <div>
                    <button className="my-4 flex items-center font-light text-lg gap-4 text-cpink-500 group hover:text-cyell-500 duration-1000">
                        <p>View Work</p>
